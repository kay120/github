...
//		System.out.println(DateFmt.getCountDate("2014-03-01 12:13:14", DateFmt.date_short));
		System.out.println(parseDate("2014-05-01 11:20:21").after(parseDate("2014-05-01 11:20:20")));
		System.out.println(parseDate("2014-05-01 11:21:21").getTime() - parseDate("2014-05-01 11:20:20").getTime());
	}
